...
#End Region
        ...
        Public Sub Populate(ByRef ID As Integer, ByRef db As CertDB)
            ...
            Catch ex As Exception
                Throw New Exception("PublicUserRegistrationDto.Populate(ByVal ID As Integer, ByRef db As CertDB) Error:   ID = " & ID.ToString & vbCrLf & ex.Message)
            End Try
        End Sub
...
#End Region
        ...
        Public Sub Populate(ByRef ID As Integer, ByRef db As CertDB)
            ...
            Catch ex As Exception
                Throw New Exception("CertificationTypeDto.Populate(ByVal ID As Integer, ByRef db As CertDB) Error:   ID = " & ID.ToString & vbCrLf & ex.Message)
            End Try
        End Sub
        ...
        Public Sub Populate(ByRef ID As Integer)
            ...
            Try
                ...
                Dim ds As DataSet = objdb.SelectByIDCertificationType(ID)
        ...
        Public Sub Populate(ByRef ID As Integer)
            ...
            Try
                ...
                If ds.Tables(0).Rows.Count > 0 Then
                    ...
                    Me.FName = dr("FName")
                    Me.LName = dr("LName")
                    Me.EmployeeNumber = dr("EmployeeNumber")
                    Me.Active = dr("Active")
                    Me.EmailAddress = dr("EmailAddress")
                    Me.ManagerID = dr("ManagerID")
                    Me.CreatedByID = dr("CreatedByID")
                    Me.CreatedByDate = dr("CreatedByDate")
